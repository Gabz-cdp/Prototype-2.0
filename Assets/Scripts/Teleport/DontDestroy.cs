...
{                                                                      //static variables: will be shared by all objects that have the DontDestroy script on them
    private static GameObject[] persistentObjects = new GameObject[10]; //persistentObjects: creates an array with all the objects that we want to persist from scene to scene
